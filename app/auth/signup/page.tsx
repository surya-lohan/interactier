                ...
                <div className="bg-[#171F33] w-2/6 h-fit p-4 rounded-md">
                    ...
                    <div className="p-2 mt-4 flex flex-col justify-center gap-2">
                        <div className="p-2">
                            ...
                            <input className="rounded-sm py-2 px-3 w-full border-gray-400 border" type="text" placeholder="Jhon doe" />
                        </div>
                        <div className="p-2">
                        ...
                        <button className="bg-[#8083FF] m-3 rounded-md p-4 text-[#100398] font-bold hover:cursor-pointer hover:bg-[#3232ed] hover:text-white transition-all ease-in delay-75">Create Account</button>
                        <h4 className="text-center text-sm">Already have an account? <a className="underline" href="">Sign in</a></h4>
                    </div>
                </div>
            </div>
        </>
