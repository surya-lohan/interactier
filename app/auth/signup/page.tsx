...
export default function SignUp() {
    ...
    return (
        <div className="relative min-h-screen w-full bg-[#070D1E] text-slate-100 flex items-center justify-center p-4 sm:p-6 overflow-hidden selection:bg-[#8083FF]/30">
            ...
            <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[550px] h-[550px] bg-[#8083FF]/12 rounded-full blur-[120px] pointer-events-none" />
            <div className="absolute bottom-10 right-10 w-[350px] h-[350px] bg-[#4F46E5]/10 rounded-full blur-[100px] pointer-events-none" />
            <div className="absolute top-10 left-10 w-[300px] h-[300px] bg-[#38BDF8]/5 rounded-full blur-[90px] pointer-events-none" />
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative flex items-center">
                                ...
                                <input
                                    ...
                                    className="w-full rounded-xl bg-[#090E1F]/90 border border-slate-700/70 pl-10 pr-3.5 py-2.5 text-sm text-white placeholder:text-slate-500 focus:outline-none focus:border-[#8083FF] focus:ring-2 focus:ring-[#8083FF]/20 transition-all"
                                />
                            </div>
                        </div>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative flex items-center">
                                ...
                                <input
                                    ...
                                    placeholder="••••••••••••"
                                    className="w-full rounded-xl bg-[#090E1F]/90 border border-slate-700/70 pl-10 pr-10 py-2.5 text-sm text-white placeholder:text-slate-500 focus:outline-none focus:border-[#8083FF] focus:ring-2 focus:ring-[#8083FF]/20 transition-all font-mono"
                                />
                                <button
                                    type="button"
